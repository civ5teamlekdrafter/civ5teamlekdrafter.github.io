$(document).ready(function() {
	...
	allCivs["Celts"] = true;
	allCivs["China"] = true;
	allCivs["Denmark"] = false;
	allCivs["Egypt"] = true;
	allCivs["England"] = false;
	...
	allCivs["Sweden"] = true;
	allCivs["Tibet"] = false;
	allCivs["Timurids"] = false;
	allCivs["Ukraine"] = true;
	allCivs["Vatican"] = false;
	allCivs["Venetian"] = false;
		...
		// errors handled we can now make the draw
			...
			for (i = 1; i <= players; i++) { 
				...
				for (k = 1; k <= rndpicks; k++) {
					...
					picksHTML = picksHTML + "<td>" + allowedCivs[thisciv];
